            ...
            <div class="form-row">
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        <h5 class="">Referral bonus should come from </h5>
                        <select name="referral_proffit_from" class="form-control">
                            <option>{{ $settings->referral_proffit_from }}</option>
                            <option>Deposit</option>
                            <option>Profit(ROI)</option>
                        </select>
                    </div>
                </div>
            </div>
                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="use_copytrade" value="1" class="selectgroup-input"
                                {{ $settings->use_copytrade ? 'checked' : '' }}>
                            <span class="selectgroup-button">Yes</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="use_copytrade"
                                {{ !$settings->use_copytrade ? 'checked' : '' }} value="0"
                                class="selectgroup-input">
                            <span class="selectgroup-button">No</span>
                        </label>
                    </div>
