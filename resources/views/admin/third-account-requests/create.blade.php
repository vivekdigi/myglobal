...
@section('content')
    ...
    <div class="mt-2 mb-3 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="title1 mb-0">Create Third Account</h4>
            <small class="text-muted">Create a third trading account for an existing user</small>
        </div>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fa fa-user-plus mr-2"></i>New Third Account</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.third.store') }}" method="POST" id="createThirdForm">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="email"
                                       ...
                                       class="form-control"
                                       value="{{ old('email') }}"
                                       placeholder="e.g. 3majesty_username@gmail.com"
                                       required>
                                <div class="input-group-append">
                            ...
                            <small class="text-muted">
                                Auto prefix: <code>3majesty_</code> + parent email
                            </small>
                            @error('email')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div id="passwordWarningBox" class="alert alert-warning py-2 px-3 d-none" style="font-size:.85rem;">
                            ...
                            The third account will be created without passwords.
                        </div>
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">
                                Dashboard Login Password
                                <span class="text-danger">*</span>
                                <small class="text-muted font-weight-normal">(for third account login)</small>
                            </label>
                            <div class="input-group">
                                <input type="text"
                                       name="login_password"
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <small class="text-success">
                                ...
                                Welcome email with investor & master password will be sent to user and support.
                            </small>
...
$(document).ready(function () {
    ...
    $(document).on('click', '.user-result-item', function () {
        ...
        $('#thirdEmail').val('3majesty_' + parts[0] + '@' + parts[1]);
    ...
    function loadCredentials(userId) {
        $.get('{{ route("admin.secondary.credentials") }}', { user_id: userId, prefix: '3' }, function (data) {
            // New third account ID (last+1)
            ...
            if (!$('#thirdEmail').val()) {
                $('#thirdEmail').val(data.suggested_email);
            }
    ...
    $('#autoEmailBtn').on('click', function () {
        ...
        $('#thirdEmail').val('3majesty_' + parts[0] + '_' + accountid + '@' + parts[1]);
    });
