    ...
    <div class="mt-2 mb-3 d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h4 class="title1 mb-0">
                <i class="fa fa-trash text-danger mr-2"></i>Trashed Fourth Accounts
            </h4>
            ...
            <div class="card">
                <div class="card-header py-2">
                    <div class="d-flex align-items-center flex-wrap" style="gap:8px;">
                        {{-- Search --}}
                        <form method="GET" action="{{ route('admin.fourth.trashed') }}" class="d-flex align-items-center" style="gap:8px;">
                            ...
                            @if($search)
                                <a href="{{ route('admin.fourth.trashed') }}" class="btn btn-sm btn-secondary">
                        ...
                        <div id="bulkBar" class="d-none align-items-center" style="gap:8px;">
                            ...
                            {{-- Bulk Restore --}}
                            <form id="bulkRestoreForm" action="{{ route('admin.fourth.bulk-restore') }}" method="POST"
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="trashDrop{{ $acc->id }}">
                                                    {{-- Restore --}}
                                                    <form action="{{ route('admin.fourth.restore', $acc->id) }}" method="POST">
                                                        @csrf
                                                    ...
                                                    {{-- Permanent delete --}}
                                                    <form action="{{ route('admin.fourth.force-destroy', $acc->id) }}" method="POST"
                                    ...
                                    <tr>
                                        <td colspan="8" class="text-center py-5 text-muted">
                                            ...
                                            @else
                                                ...
                                                Trash is empty — no deleted fourth accounts.
                                            @endif
                                        </td>
                                    </tr>
                                @endforelse
