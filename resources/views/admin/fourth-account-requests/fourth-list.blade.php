...
@section('content')
    ...
    <div class="mt-2 mb-3 d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h4 class="title1 mb-0">Fourth Accounts</h4>
            <small class="text-muted">All created fourth trading accounts with credentials</small>
        </div>
        <div class="d-flex" style="gap:8px;">
            <span class="badge badge-primary badge-pill px-3 py-2" style="font-size:.85rem;">
                {{ $accounts->total() }} Total
            </span>
            <a href="{{ route('admin.fourth.trashed') }}" class="btn btn-sm btn-outline-danger" style="border-radius:50px;">
            ...
            <div class="card">
                <div class="card-header py-2">
                    <div class="d-flex align-items-center flex-wrap" style="gap:8px;">
                        {{-- Search --}}
                        <form method="GET" action="{{ route('admin.fourth.list') }}" class="d-flex align-items-center" style="gap:8px;">
                            ...
                            @if($search)
                                <a href="{{ route('admin.fourth.list') }}" class="btn btn-sm btn-secondary">
                                            ...
                                            <div class="modal fade" id="changePwdModal{{ $acc->id }}" tabindex="-1" role="dialog">
                                                <div class="modal-dialog modal-sm" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('admin.fourth.updatepwd', $acc->id) }}" method="POST">
                                                            @csrf
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="secDropdown{{ $acc->id }}">
                                                    ...
                                                    <form action="{{ route('admin.fourth.destroy', $acc->id) }}" method="POST"
                                                          onsubmit="return confirm('Move fourth account {{ $acc->accountid }} to trash?')">
                                                        @csrf
                                                        @method('DELETE')
                                    ...
                                    <tr>
                                        <td colspan="12" class="text-center py-5 text-muted">
                                            ...
                                            @else
                                                ...
                                                No fourth accounts created yet.
                                                <br>
                                                <a href="{{ route('admin.fourth.create') }}" class="btn btn-sm btn-primary mt-2">
                                                    Create First Fourth Account
                                                </a>
                                            @endif
                                        </td>
                                    </tr>
