    ...
    <div class="page-title">
        <div class="row justify-content-between align-items-center">
            <div class="mb-3 col-md-6 mb-md-0">
                <h5 class="mb-0 text-white h3 font-weight-400">Welcome, {{ Auth::user()->name }}! </br>Account Id : {{ Auth::user()->accountid }} @if (!empty(Auth::user()->accountid_sec)), {{ Auth::user()->accountid_sec }} @endif @if(Auth::user()->name == 'Aamir mustafa') , 36133 , 36134 @endif </h5><p> (Please check your email for login credentials)</p>
            </div>
            <div class="mb-3 col-md-6 mb-md-0 text-md-right">
                @if(!$is_secondary)
                    ...
                    <div class="row justify-content-end" style="gap: 14px 12px; margin-bottom: 35px;">
                        @if($demo_request)
            ...
            <style>
                @media (max-width: 576px) {
                    ...
                    .page-title .row > div:last-child .row {
