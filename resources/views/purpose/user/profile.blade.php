                        ...
                        <div class="p-2 col-md-12 p-md-4">
                            ...
                            <div class="tab-content p-2 p-md-4">
                                <div class="tab-pane fade show active" id="per">
                                    @include('purpose.profile.update-profile-information-form')
                                </div>
                                <div class="tab-pane fade" id="set">
                                    @include('purpose.profile.update-withdrawal-method')
                                </div>
                                <div class="tab-pane fade" id="pas">
                                    @include('purpose.profile.update-password-form')
                                </div>
                                <div class="tab-pane fade" id="sec">
                                    @include('purpose.profile.update-security-form')
                                </div>
                            </div>
                        </div>
                    </div>
