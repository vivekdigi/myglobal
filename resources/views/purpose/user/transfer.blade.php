                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <form method="post" action="javascript:void(0)" id="transferform">
                                            ...
                                            <div class="form-group">
                                                <label for="" class="">Sender (User) Recipient Email or Username or Account Id <span
                                                        class=" text-danger">*</span></label>
                                                <input type="text" name="emailr" class="form-control " required value="{{ Auth::user()->email }} | {{ Auth::user()->username }} | {{ Auth::user()->accountid }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="">Enter Receiver Parent Recipient Email or Username or Account Id <span
                                                        class=" text-danger">*</span></label>
                                            ...
                                            <div class="form-group">
                                            <label for="">Remark add transfer from to transfer <span class="text-danger">*</span></label>
                                            <input type="text" name="remark" class="form-control" required placeholder="Enter remark" maxlength="500">
                                            </div>

                                            <div class="form-group">
                                            <label for="">Transfer From* </label>
                                            <input type="text" name="transfer_from" class="form-control" placeholder="Added Account Sender ID" required value="{{ Auth::user()->name }}" placeholder="From">
                                            </div>

                                            <div class="form-group">
                                            <label for="">Transfer To* </label>
                                            <input type="text" name="transfer_to" class="form-control" required placeholder="Added Account Receiver ID">
                                            </div>
