    ...
    <div class="page-title">
        <div class="row justify-content-between align-items-center">
            <div class="mb-3 col-md-6 mb-md-0">
                <h5 class="mb-0  h3 font-weight-400">Account Settings</h5>
            </div>
        </div>
    </div>
    <x-danger-alert />
                        ...
                        <div class="p-2 col-md-12 p-md-4">
                            ...
                            <div class="tab-content p-2 p-md-4">
                                <div class="tab-pane fade show active" id="per">
                                    @include('millage.profile.update-profile-information-form')
                                </div>
                                <div class="tab-pane fade" id="set">
                                    @include('millage.profile.update-withdrawal-method')
                                </div>
                                <div class="tab-pane fade" id="pas">
                                    @include('millage.profile.update-password-form')
                                </div>
                                <div class="tab-pane fade" id="sec">
                                    @include('millage.profile.update-security-form')
                                </div>
                            </div>
                        </div>
                    </div>
