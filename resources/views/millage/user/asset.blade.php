...
@section('content')
    ...
    <div class="page-title">
        <div class="row justify-content-between align-items-center">
            <div class="mb-3 col-md-6 mb-md-0">
                <p class="mb-0 h3 font-weight-400">Swap Crypto</p>
            </div>
        </div>
    </div>
    <x-danger-alert />
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="p-3 card  shadow">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-1 "><b>{{ round($cbalance->btc, 8) }}
                                                        BTC</b></p>
                            ...
                            <div class="col-md-4">
                                <form method="POST" action="javascript:void(0)" id="exchnageform">
                                    ...
                                    <div class="form-group">
                                        <p class="">Source Account</p>
                                        <select class="form-control  " name="source" id="sourceasset">
                                            @if ($moresettings->btc == 'enabled')
                                    ...
                                    <div class="form-group">
                                        <p class="">Destination Account</p>
                                        <select name="destination" class="form-control  " id="destinationasset">
                                            <option value="usd">USD</option>
                                            @if ($moresettings->btc == 'enabled')
                                                <option value="btc">BTC</option>
                                            @endif
                                        ...
                                        <small class="">NOTE:USD is your account balance.</small>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <p class="">You will get</p>
                                        <input type="text" class="form-control  " placeholder="Quantity of usd"
                                            id="quantity" readonly </div>
    ...
    @include('millage.user.exchangescript')
@endsection
