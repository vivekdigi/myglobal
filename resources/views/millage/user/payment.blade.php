...
<div class="page-title">
    <div class="row justify-content-between align-items-center">
        <div class="mb-3 col-md-6 mb-md-0">
            <h5 class="mb-0  h3 font-weight-400">Make Payment</h5>
        </div>
    </div>
</div>
<x-danger-alert />
                            ...
                            <div class="card-body">
                                ...
                                @if ($title != 'Complete Payment')
                                    ...
                                    <div>
                                        ...
                                        <h6 class="testp">For Local Bank Accounts Details, Please Contact to out live Customer Care No. +447429919408
                                        </h6>
                                        <h4>
