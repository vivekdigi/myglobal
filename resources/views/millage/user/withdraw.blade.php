    ...
    <div class="page-title">
        <div class="row justify-content-between align-items-center">
            <div class="mb-3 col-md-6 mb-md-0">
                <h5 class="mb-0  h3 font-weight-400">Withdrawal Details</h5>
            </div>
        </div>
    </div>
    <div>
                                    ...
                                    @else
                                        <form action="{{ route('completewithdrawal') }}" method="post">
                                                ...
                                                @if ($methodtype == 'crypto')
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control "
                                                            placeholder="Enter {{ $payment_mode }} Address" type="text"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="Enter MT5 Account ID" type="number" name="accountid" required oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                            </div>
                                            <div class="form-group">
