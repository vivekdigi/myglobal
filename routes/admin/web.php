...
Route::middleware(['isadmin', '2fa'])->prefix('admin/dashboard')->group(function () {
    ...
    Route::middleware('settings.otp')->group(function () {
    ...
    Route::controller(PaymentController::class)->group(function () {
        Route::get('settings/payment-settings/otp', 'showPaymentOtpForm')->name('admin.settings.payment.otp');
        Route::post('settings/payment-settings/otp', 'verifyPaymentOtp')->name('admin.settings.payment.verify');
        Route::get('settings/payment-settings/otp/resend', 'resendPaymentOtp')->name('admin.settings.payment.resend');
    });
