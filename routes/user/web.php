...
use App\Http\Controllers\User\DemoAccountController;
use App\Http\Controllers\User\SecondAccountController;
...
// Route::get('activate-local', function () {
//     Http::post('https://onlinetrade.questdigiflex.in/api/v1/save-license', [
//         'license' => '50M9-KKVA-ZODP-39OR',
//         'website' =>  $_SERVER['HTTP_HOST'],
//         'username' => 'Onlinetrade local dev',
//     ]);
//     return 'activated';
// });
...
Route::get('/dashboard/ref/{id}', 'App\Http\Controllers\Controller@ref');
...
Route::middleware(['auth:sanctum', 'verified'])->prefix('dashboard')->group(function () {
    ...
    Route::middleware('complete.kyc')->group(function () {
        ...
        Route::get('withdrawal-history', [ViewsController::class, 'withdrawHistory'])->name('withdrawlhistory');
        Route::get('profit-history', [ViewsController::class, 'profitHistory'])->name('profithistory');
        Route::get('other-history', [ViewsController::class, 'otherHistory'])->name('otherhistory');
        ...
        Route::get('account/providers', [ViewsController::class, 'providers'])->name('acnt.providers');
        Route::get('account-invoices', [ViewsController::class, 'invoice'])->name('acnt.invoice');
        // pay invoice
        Route::get('payinvoice/{id}', [UserSubscriptionController::class, 'payInvoice'])->name('payinvoice');

        Route::get('account-metrics/{account}/{name}', [ViewsController::class, 'providerAccountMetrics'])->name('prov.metrics');
        ...
        Route::get('cancel-payment', [DepositController::class, 'cancelPayment'])->name('cancelpayment');
        ...
        Route::post('request-demo-account', [DemoAccountController::class, 'requestDemo'])->name('demo.request');
